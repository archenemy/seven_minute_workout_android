...
public class WorkoutListActivity extends FragmentActivity implements WorkoutListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (WorkoutContent.WORKOUTS.isEmpty()) {
            WorkoutContent.addWorkout(new Workout("1",
                    getString(R.string.jumping_jacks),
                    getString(R.string.jumping_jacks_desc),
                    getString(R.string.jumping_jacks_video),
                    getString(R.color.jumping_jacks_dark),
                    getString(R.color.jumping_jacks_light)));
            WorkoutContent.addWorkout(new Workout("2",
                    getString(R.string.wall_sits),
                    getString(R.string.wall_sits_desc),
                    getString(R.string.wall_sits_video),
                    getString(R.color.wall_sits_dark),
                    getString(R.color.wall_sits_light)));
            WorkoutContent.addWorkout(new Workout("3",
                    getString(R.string.push_ups),
                    getString(R.string.push_ups_desc),
                    getString(R.string.push_ups_video),
                    getString(R.color.push_ups_dark),
                    getString(R.color.push_ups_light)));
            WorkoutContent.addWorkout(new Workout("4",
                    getString(R.string.abdominal_crunches),
            ...
            WorkoutContent.addWorkout(new Workout("5",
                    getString(R.string.step_ups_onto_a_chair),
            ...
            WorkoutContent.addWorkout(new Workout("6",
                    getString(R.string.squats),
                    getString(R.string.squats_desc),
                    getString(R.string.squats_video),
                    getString(R.color.squats_dark),
                    getString(R.color.squats_light)));
            WorkoutContent.addWorkout(new Workout("7",
                    getString(R.string.triceps_dips_on_a_chair),
            ...
            WorkoutContent.addWorkout(new Workout("8",
                    getString(R.string.planks),
                    getString(R.string.planks_desc),
                    getString(R.string.planks_video),
                    getString(R.color.planks_dark),
                    getString(R.color.planks_light)));
            WorkoutContent.addWorkout(new Workout("9",
                    getString(R.string.high_knees_running_in_place),
            ...
            WorkoutContent.addWorkout(new Workout("10",
                    getString(R.string.lunges),
                    getString(R.string.lunges_desc),
                    getString(R.string.lunges_video),
                    getString(R.color.lunges_dark),
                    getString(R.color.lunges_light)));
            WorkoutContent.addWorkout(new Workout("11",
                    getString(R.string.push_ups_and_rotations),
            ...
            WorkoutContent.addWorkout(new Workout("12",
                    getString(R.string.side_planks),
                    getString(R.string.side_planks_desc),
                    getString(R.string.side_planks_video),
                    getString(R.color.side_planks_dark),
                    getString(R.color.side_planks_light)));
        }
